...
struct StoryBrain {
    let story = [
        Story(
            ...
            c2: "Well, I don't have many options. Better ask him if he's a murderer.", cd2: 1
        ),
        Story(
        ...
        Story(
            ...
            c1: "The", cd1: 0,
            c2: "It’s him or me. Take the knife and stab him.", cd2: 4
        )
    ]
    
    var storyNumber = 0
    
    func getAnswerTextOne() -> String {
        return story[storyNumber].choiceOne
    }
    func getAnswerTextTwo() -> String {
        return story[storyNumber].choiceTwo
    }
    ...
    mutating func nextStory(_ userAnswer: String) {
        ...
        if( userAnswer == story[storyNumber].choiceOne) {
            storyNumber = story[storyNumber].choiceOneDestination
        }
        if(userAnswer == story[storyNumber].choiceTwo) {
            storyNumber = story[storyNumber].choiceTwoDestination
        }
